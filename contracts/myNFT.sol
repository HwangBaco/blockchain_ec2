...
contract myNFT is ERC721 {
    ...
    function mint(
        ...
        require(/* 채우세요 */_to != address(0), "Empty address cannot mint NFT");
        uint _tokenId = /* 토큰ID는 발행될 때마다 0부터 차례대로 부여 */ images.length;
    ...
    function ownerHistoryOf(uint256 tokenId) public
        ...
        return /* 채우세요 */ tokenOwnerHistory[tokenId];
    }
    ...
    function _exists(uint256 tokenId) internal
        view returns (bool) {
        /* tokenId의 소유자를 받아옵니다. */
        address owner = /* 채우세요 */  tokenOwner[tokenId];
    ...
    function ownerOf(uint256 _tokenId) public
        ...
        return /* 채우세요 */tokenOwner[_tokenId];
    }

    // 토큰 판매 시작
    function sellToken(uint256 _tokenId) public {
        /* 함수를 호출하는 주소는 해당 토큰Id의 보유자여야 합니다. */
        require(/* 채우세요 */msg.sender == tokenOwner[_tokenId], "Only owner can sell token");
        /* onSale 함수를 호출해 해당 토큰Id의 판매 상태를 true로 바꿉니다. */
        onSale(/* 채우세요 */_tokenId, true);
    ...
    function onSale(uint256 _tokenId, bool _forSale) public {
        isForSale[_tokenId] = /* 채우세요 */_forSale;
    }
    ...
    function buyToken(uint256 _tokenId) public payable {
        ...
        */
        ...
        payable(owner).transfer(/* 채우세요 */tokenPrice[_tokenId]);
        /* 토큰을 구매자의 소유로 이동 */
    ...
    function transferFrom(
        ...
        */
        ...
        tokenOwner[_tokenId] = /* 소유자 주소 변경 전 초기화하세요 */address(0); 
        tokenBalance[_to] += 1;
        tokenOwner[_tokenId] = /* 채우세요 */ _to;
        /* 토큰 전송 이벤트 호출 */
